...
def nameGen
    ...
    snt3 = (rand() * 3 | 0)
    if snt1 === 0 
        rnd = (rand() * nm1a.length | 0)
        rnd2 = (rand() * nm2a.length | 0)
        names1 = nm1a[rnd] + " " + nm2a[rnd2]
    elsif snt1 === 1
        rnd = (rand() * nm1b.length | 0)
        rnd2 = (rand() * nm2b.length | 0)
        names1 = nm1b[rnd] + " " + nm2b[rnd2]
    elsif snt1 === 2
        rnd = (rand() * nm1c.length | 0)
        rnd2 = (rand() * nm2c.length | 0)
        names1 = nm1c[rnd] + " " + nm2c[rnd2]
    elsif snt1 === 3
        rnd = (rand() * nm5a.length | 0)
        rnd2 = (rand() * nm2c.length | 0)
        names1 = nm5a[rnd] + " " + nm2c[rnd2]
    elsif snt1 === 4
        rnd = (rand() * nm5b.length | 0)
        rnd2 = (rand() * nm6b.length | 0)
        names1 = nm5b[rnd] + " " + nm6b[rnd2]
    end
    if snt2 === 0
        rnd = (rand() * nm3a.length | 0)
        rnd2 = (rand() * nm4a.length | 0)
        names2 = nm3a[rnd] + " " + nm4a[rnd2]
    elsif snt2 === 1
        rnd = (rand() * nm3b.length | 0)
        rnd2 = (rand() * nm4b.length | 0)
